...
Jii.defineClass('Jii.comet.server.NeatServer', /** @lends Jii.comet.server.NeatServer.prototype */{
    ...
    _onModelInsert: function(event) {
        ...
        this._neat.broadcastEvent(model.className(), 'sendAdd', model.getAttributes());
    },
    ...
    _onModelUpdate: function(event) {
        ...
        this._neat.broadcastEvent(model.className(), 'sendUpdate', model.getAttributes(), oldAttributes);
    },
    ...
    _onModelDelete: function(event) {
        ...
        this._neat.broadcastEvent(model.className(), 'sendRemove', model.getAttributes());
    },
